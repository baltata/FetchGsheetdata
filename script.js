...
for (var i = 0, len = liste.length; i < len; i++) {
    ...
    liste[i].insertAdjacentHTML('beforeend','<div class="blur"> <div class="gosabonner">Cet exercice est réservé à nos utilisateurs premium &#128081. <br><a class="awhite" href="httms://galilee.ac/local/membership/plan.php"> <div class="whitebutton"><b> Nos offres</b></div></a> </div>')
}}
}
